...
class AskQuestionView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if action == 'SAVE':
            ...
            ctx = super().get_context_data(preview=preview)
...
class QuestionDetailView(DetailView):
    ...
    ACCEPT_FORM = AnswerAcceptanceForm(initial={
        'accepted': True
    })
    REJECT_FORM = AnswerAcceptanceForm(initial={
        'accepted': False
    })
    ...
    def form_valid(self, form):
        ...
        if action == 'SAVE':
            ...
            preview = Question(question=form.cleaned_data['question'],
                               title=form.cleaned_data['question'].title)
...
class UpdateAnswerAcceptance(LoginRequiredMixin, UpdateView):
    ...
    def form_invalid(self, form):
        return HttpResponseRedirect(to=self.object.question.get_absolute_url())
